...
export default function PhotosUploader({ addedPhotos = [], onChange = () => {} }) {
  ...
  function uploadPhoto(ev) {
    ...
    axios.post('http://localhost:5000/upload', data)
      .then(response => {
        const filenames = response.data; // response.data is an array of URLs
        // Add all uploaded image URLs to the state
        onChange([...addedPhotos, ...filenames]);
        console.log("Photo upload successful:", filenames);
        console.log("Added photos:", [...addedPhotos, ...filenames]);
      })
      .catch(error => {
